                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control border-input" disabled placeholder="Producto" >
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>Donante</label>
                                                        <input type="text" class="form-control border-input" placeholder="Empresa o persona natural" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="" class="form-control border-input">
