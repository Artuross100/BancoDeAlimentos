...
@Entity
@Table(catalog = "ufps_87", schema = "", uniqueConstraints = {
...
@NamedQueries({
    ...
    @NamedQuery(name = "TipoIdentificacion.findByFecha", query = "SELECT t FROM TipoIdentificacion t WHERE t.fecha = :fecha")})
